...
--8.Which tournament categories (e.g., Grand Slams, Challengers, 250s) host the highest volume of individual competitions?
SELECT
...
--9. How many categories exist in the dataset?
SELECT COUNT(*) AS total_categories
FROM tennis.category;

---------------------------------------------------------------------------------------

--10. How many competitions are recorded?
SELECT COUNT(*) AS total_competitions
FROM tennis.competition;

---------------------------------------------------------------------------------------

--11. How many sports complexes exist?
SELECT COUNT(*) AS total_complexes
FROM tennis.complex;

---------------------------------------------------------------------------------------

--12. How many venues exist?
SELECT COUNT(*) AS total_venues
FROM tennis.venue;

---------------------------------------------------------------------------------------

--13. How many competitors exist?
SELECT COUNT(*) AS total_competitors
FROM tennis.competitor;

---------------------------------------------------------------------------------------

--14. What is the highest ranking points achieved by any player?
SELECT MAX(points) AS highest_points
FROM tennis.ranking;

---------------------------------------------------------------------------------------

--15. What is the lowest ranking points recorded?
SELECT MIN(points) AS lowest_points
FROM tennis.ranking;

---------------------------------------------------------------------------------------

--16. How does ranking movement vary across players?
...
--17. Do players who play more competitions have higher ranking points?
...
--18. Which countries produce players with the highest average ranking points?
...
--19. Which countries have the most ranked competitors?
...
--20. Which timezones host the most tennis venues?
